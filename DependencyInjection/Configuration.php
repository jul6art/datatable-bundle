                ...
                ->arrayNode('status_maps')
                    ...
                    ->arrayPrototype()
                        ->children()
                            ...
                            ->end()
                            ->scalarNode('domain')
                                ->info('Translation domain of the keys. Defaults to `translation_domain`, so a project that moved its datatable catalogue does not have to repeat the domain on every map.')
                                ->defaultNull()
                            ->end()
